...
.. image:: https://godoc.org/github.com/eatools/gopher-lua?status.svg
    :target: http://godoc.org/github.com/eatools/gopher-lua

.. image:: https://travis-ci.org/eatools/gopher-lua.svg
    :target: https://travis-ci.org/eatools/gopher-lua

.. image:: https://coveralls.io/repos/eatools/gopher-lua/badge.svg
    :target: https://coveralls.io/r/eatools/gopher-lua

.. image:: https://badges.gitter.im/Join%20Chat.svg
    :alt: Join the chat at https://gitter.im/eatools/gopher-lua
    :target: https://gitter.im/eatools/gopher-lua?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge
...
There are some benchmarks on the `wiki page <https://github.com/eatools/gopher-lua/wiki/Benchmarks>`_ .
...
.. code-block:: bash
   ...
   go get github.com/eatools/gopher-lua
...
Refer to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ and `Go doc <http://godoc.org/github.com/eatools/gopher-lua>`_ for further information.

Note that elements that are not commented in `Go doc <http://godoc.org/github.com/eatools/gopher-lua>`_ equivalent to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ , except GopherLua uses objects instead of Lua stack indices.
...
Refer to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ and `Go doc(LState methods) <http://godoc.org/github.com/eatools/gopher-lua>`_ for further information.
...
Refer to `Go doc(LState methods) <http://godoc.org/github.com/eatools/gopher-lua>`_ for further information.
...
.. code-block:: bash
   ...
   go get github.com/eatools/gopher-lua/cmd/glua
...
How to Contribute
----------------------------------------------------------------
See `Guidlines for contributors <https://github.com/eatools/gopher-lua/tree/master/.github/CONTRIBUTING.md>`_ .
...
- `gluamapper <https://github.com/eatools/gluamapper>`_ : Mapping a Lua table to a Go struct
- `gluare <https://github.com/eatools/gluare>`_ : Regular expressions for gopher-lua
